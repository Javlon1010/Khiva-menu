...
const I18N = {
  uz: {
    title_sayt: 'Hamirli taomlar — Qala Restaurant',
    title: 'HAMIRLI TAOMLAR',
    back: 'Orqaga',
    restaurantMeta: "O'zbekiston, Xiva shahri",
    statusOpen: 'Taomlar',
  },
  ru: {
    title_sayt: 'Основные блюда — Qala Restaurant',
    title: 'БЛЮДА ИЗ ТЕСТА',
    back: 'Назад',
    restaurantMeta: 'Город Хива, Узбекистан',
    statusOpen: 'Блюды',
  },
  en: {
    title_sayt: 'Stuffed Dishes — Qala Restaurant',
    title: 'STUFFED DISHES',
    back: 'Back',
