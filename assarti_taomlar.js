const MAIN_DISHES = [
     {
  id: 'shashlik_assorti_6p',
  name: {
    uz: 'Shashlik assorti 6 ta',
    ru: 'Шашлык ассорти 6 п',
...
const I18N = {
  uz: {
    title_sayt: 'Assorti taomlar — Qala Restaurant',
    title: 'ASSORTI TAOMLAR',
    back: 'Orqaga',
    restaurantMeta: "O'zbekiston, Xiva shahri",
    statusOpen: 'Taomlar',
  },
  ru: {
    title_sayt: 'Разнообразные блюда — Qala Restaurant',
    title: 'РАЗНООБРАЗНЫЕ БЛЮДА',
    back: 'Назад',
    restaurantMeta: 'Город Хива, Узбекистан',
    statusOpen: 'Блюды',
  },
  en: {
    title_sayt: 'ASSORTED DISHES — Qala Restaurant',
